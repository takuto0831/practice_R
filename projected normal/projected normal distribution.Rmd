...
fit <- stan("C:/Users/Rstudio/Desktop/practice_R/projected normal/script/test.stan",
            data=list(N=2000,theta=pn_sample),iter = 10000,chains = 5,open_progress = FALSE)
```
...
# 真値と予測値をプロット
theta = seq(0,2*pi,0.01)
x_ <- foreach(i=theta, .combine = c) %do% projected_normal_circular(i,mu_,Sigma_)
data.frame(theta = theta,True = x,predict = x_) %>%
